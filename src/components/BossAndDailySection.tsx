...
import { Swords, Flame, Sparkles, Check } from 'lucide-react';
    ...
    <section className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-slate-600">
              Defeat category boss monsters and complete daily focus habits for massive XP rewards!
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <h3 className="text-sm font-black uppercase tracking-wider text-slate-700 flex items-center gap-1.5">
          <Swords className="w-4 h-4 text-rose-500" /> Category Boss Battles
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {bossChallenges.map((boss) => {
            ...
            const categoryInfo = boss.category ? CATEGORIES[boss.category] : null;
      ...
      <div className="space-y-3 pt-2">
        <h3 className="text-sm font-black uppercase tracking-wider text-slate-700 flex items-center gap-1.5">
          <Flame className="w-4 h-4 text-amber-500" /> Daily Focus Habits
        </h3>
